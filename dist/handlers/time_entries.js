import { asNumber, asNumberOrSpecial, extractPaginationParams, ValidationError, } from "./types.js";
 ...
 */
function extractTimeEntryParams(args) {
    const params = {};
 ...
 */
function isRedmineTimeEntryCreate(value) {
...
export function createTimeEntriesHandlers(context) {
