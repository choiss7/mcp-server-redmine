...
export const ProjectQuerySchema = z.object({
    ...
    include: z
        ...
        .refine((value) => value
        .split(",")
        .every((item) => validIncludeValues.includes(item)), "Invalid include value. Must be comma-separated list of: trackers, issue_categories, enabled_modules, time_entry_activities, issue_custom_fields")
        .optional(),
});
