// List issues tool
export const ISSUE_LIST_TOOL = {
    name: "list_issues",
    description: "List and search Redmine issues. " +
    ...
    inputSchema: {
        ...
        properties: {
            ...
            sort: {
                type: "string",
                description: "Sort field and direction like last.updated:desc or priority:asc",
                pattern: "^[a-z_]+(:(asc|desc))?$",
            },
            // Include additional data
            include: {
                type: "string",
                description: "Additional data to include as comma separated values\n" +
            ...
            subproject_id: {
                type: "string",
                description: "Control subproject inclusion. Use !* to exclude subprojects",
            },
            tracker_id: {
                type: "number",
...
// Create issue tool
export const ISSUE_CREATE_TOOL = {
    name: "create_issue",
...
// Update issue tool
export const ISSUE_UPDATE_TOOL = {
    name: "update_issue",
...
// Delete issue tool
export const ISSUE_DELETE_TOOL = {
    name: "delete_issue",
...
export const ISSUE_ADD_WATCHER_TOOL = {
...
export const ISSUE_REMOVE_WATCHER_TOOL = {
