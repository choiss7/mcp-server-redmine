...
export const TIME_ENTRY_LIST_TOOL = {
    ...
    description: "List and search logged time records. " +
...
export const TIME_ENTRY_SHOW_TOOL = {
    ...
    description: "Get details of a time record. " +
...
export const TIME_ENTRY_CREATE_TOOL = {
    name: "create_time_entry",
    description: "Record spent time on projects or issues. " +
...
export const TIME_ENTRY_DELETE_TOOL = {
    ...
    description: "Delete a time record permanently. " +
