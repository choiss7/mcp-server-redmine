...
export const USER_LIST_TOOL = {
    ...
    inputSchema: {
        ...
        properties: {
            ...
            name: {
                type: "string",
                description: "Filter by login, firstname, lastname and mail. " +
